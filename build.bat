...
set "physics=%PROJECT_ROOT%\src\engine\physics\physics.cpp %PROJECT_ROOT%\src\engine\physics\spatial_hashing.cpp"
set "dataStructs=%PROJECT_ROOT%\src\engine\dataStructs\array_list.cpp %PROJECT_ROOT%\src\engine\dataStructs\hash_table.cpp"
